...
import {DrandHttpClient} from "../../src/drand/drand-client"
...
describe("drand-client", () => {
    it("propagates errors from the fetch call", async () => {
        ...
        const client = new DrandHttpClient("some-key", {fetchJson: errorFetch})
    ...
    it("returns an error if the randomness is not hex", async () => {
        ...
        const client = new DrandHttpClient("some-key", {fetchJson: successFetch})
    ...
    it("returns an error if the public key doesn't match the signer", async () => {
        ...
        // a non-matching public key
        const publicKey = "0000fc249deb0148eb918d6e213980c5d01acd7fc251900d9260136da3b54836ce125172399ddc69c4e3e11429b62c11"
        const json = {
            round: roundNumber,
        ...
        const client = new DrandHttpClient(publicKey, {fetchJson: successFetch})
